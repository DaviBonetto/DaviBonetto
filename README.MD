...
I'm an ML researcher and AI Engineer focused on 
adversarial robustness in recurrent foundation models.

My recent work — SpectralGuard — identifies and defends 
against Hidden State Poisoning Attacks (HiSPA) in 
Mamba-based State Space Models, proving that spectral 
radius monitoring provides a principled, real-time 
safety layer for SSM deployments.

I build in public: research, systems, and production AI.
...
<img src="./assets/spectral_quote.png" width="100%" alt="Spectral Philosophy" />
<br>
